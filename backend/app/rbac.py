...
PERMISSIONS={
    Role.OWNER:{"*"},
    Role.ADMIN:{"workspace:manage","scope:approve","users:manage","scan:create","scan:view","scan:cancel","scope:approve","finding:view","finding:edit","finding:assign","finding:close","report:create","report:export","audit:view"},
